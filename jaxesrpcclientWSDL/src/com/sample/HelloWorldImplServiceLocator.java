...
public class HelloWorldImplServiceLocator extends org.apache.axis.client.Service implements com.sample.HelloWorldImplService {
    ...
    private java.lang.String HelloWorldImplPort_address = "http://localhost:7779/ws/hello";
    ...
    public com.sample.HelloWorld getHelloWorldImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.sample.HelloWorld getHelloWorldImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.sample.HelloWorldImplPortBindingStub _stub = new com.sample.HelloWorldImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.sample.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.sample.HelloWorldImplPortBindingStub _stub = new com.sample.HelloWorldImplPortBindingStub(new java.net.URL(HelloWorldImplPort_address), this);
                _stub.setPortName(getHelloWorldImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://sample.com/", "HelloWorldImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://sample.com/", "HelloWorldImplPort"));
        }
